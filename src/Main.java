public class Main {
    public static void main(String[] args) {
        ...
        Book  book1  = new Book( "Мастер и Маргарита", 1966);
        System.out.println("=== === === ===");
        System.out.println("автор книги = " + author.getAuthorName());
        ...
        Book book2 =  new Book( "Кот в сапогах", 1695);
        System.out.println("автор книги = " + author1.getAuthorName());
